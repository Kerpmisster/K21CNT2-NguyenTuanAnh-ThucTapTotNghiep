...
public partial class NoiThatHoangHoanContext : DbContext
{
    public NoiThatHoangHoanContext()
    {
    }

    public NoiThatHoangHoanContext(DbContextOptions<NoiThatHoangHoanContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-SSHUBNQA\\SQLEXPRESS;Database=NoiThatHoangHoan;uid=sa;pwd=123456;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C8820A3371CA");
            ...
            entity.HasOne(d => d.AdminUser).WithMany(p => p.AdminLogs)
                ...
                .HasConstraintName("FK_ADMIN_LOG_ADMIN_USER");
        });
        ...
        modelBuilder.Entity<Extension>(entity =>
        {
            ...
            entity.HasOne(d => d.Parent).WithMany(p => p.InverseParent)
                .HasForeignKey(d => d.Parentid)
                .HasConstraintName("FK_EXTENSION_PARENT");
        });
        ...
        modelBuilder.Entity<Material>(entity =>
        {
            ...
            entity.HasOne(d => d.Parent).WithMany(p => p.InverseParent)
                .HasForeignKey(d => d.Parentid)
                .HasConstraintName("FK_MATERIAL_PARENT");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27CCAF80D7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC27A2B68082");
